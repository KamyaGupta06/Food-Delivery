  ...
  return (
    ...
    <div className='relative group cursor-pointer'>
      ...
      <ul className='absolute hidden right-0 z-[1] group-hover:flex flex-col gap-[10px] bg-[#fff2ef] py-[12px] px-[25px] rounded-[4px] border-[1px] border-[tomato] list-none z-[1]'>
          <li onClick={()=>navigate('/myorders')}className='flex items-center gap-[10px] cursor-pointer'><img className="w-[20px] "src={assets.bag_icon} alt="" /><p className='hover:text-[tomato]'>Orders</p></li>
          <hr className='w-[80px]'/>
